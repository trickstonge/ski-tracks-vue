    ...
    <div class="max-w-7xl mx-auto px-8 md:px-6 sm:px-4">
        <div class="flex justify-between h-16">
            ...
            @auth
                ...
                <div class="sm:hidden flex items-center ms-6">
                    <x-dropdown align="right" width="48">
                        <x-slot name="trigger">
                            <button class="inline-flex items-center px-3 pt-1 border-b-4 border-transparent text-base leading-4 font-medium text-sky-200 hover:text-sky-50 focus:outline-hidden transition ease-in-out duration-150">
            ...
            <div class="-me-2 hidden items-center sm:flex">
                <button @click="open = ! open" class="inline-flex items-center justify-center p-2 rounded-md text-sky-100 hover:text-sky-800 hover:bg-sky-100 focus:outline-hidden focus:bg-sky-100 focus:text-sky-800 transition duration-150 ease-in-out">
