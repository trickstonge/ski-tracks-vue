    ...
    <div class="max-w-7xl mx-auto px-8 md:px-6 sm:px-4">
      <div class="flex justify-between h-16">
        ...
        <!-- <div class="-me-2 hidden items-center sm:flex">
          <button class="inline-flex items-center justify-center p-2 rounded-md text-sky-100 hover:text-sky-800 hover:bg-sky-100 focus:outline-none focus:bg-sky-100 focus:text-sky-800 transition duration-150 ease-in-out" @click="open = ! open">
